...
class Ice extends Source {
    ...
    Ice(String mountpoint, MySocket mysocket, List<String> headerfromice, String protocol) {
        super(mountpoint);
...
//        catch(Exception ee){ }
                    ...
                    if (JRoar.icepasswd != null && (java.util.Arrays.equals(code, ("source:" + JRoar.icepasswd).getBytes()) || java.util.Arrays.equals(code, ("relay:" + JRoar.icepasswd).getBytes()))
                            ) {
                        accept = true;
                    }
                    headerfromice.remove(foo);
