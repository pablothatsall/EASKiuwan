...
public class JRoar extends Applet implements Runnable {
    ...
    static final List<MountPointListener> mplisteners = new ArrayList<>();
...
//        System.err.println("Unknown class: "+arg[i+2]);
                ...
                try {
                    Class<MountPointListener> c = (Class<MountPointListener>) Class.forName(arg[i + 1]);
                    System.out.println("c: " + c);
                    addMountPointListener((c.newInstance()));
                } catch (Exception e) {
    ...
    */
    ...
    static List<String> fetch_m3u(String m3u) {
    ...
    public static Hashtable<String, Source> getSources() {
